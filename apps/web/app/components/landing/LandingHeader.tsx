...
const LandingHeader: React.FC = () => {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50 bg-background/95 border-b border-border text-foreground backdrop-blur supports-[backdrop-filter]:bg-background/90'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-16'>
          {/* Logo */}
          <div className='flex-shrink-0'>
            <Link href='/' className='flex items-center gap-3 text-decoration-none text-foreground'>
