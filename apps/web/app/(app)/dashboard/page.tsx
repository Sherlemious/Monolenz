    ...
    <div className="min-h-full bg-background p-8">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/dashboard/profile" className="group flex items-center gap-4 p-5 bg-primary border border-primary rounded-xl transition-all hover:shadow-lg hover:shadow-primary/20">
          ...
          <Link href="/dashboard/profile/edit" className="group flex items-center gap-4 p-5 bg-card border border-border rounded-xl transition-all hover:border-ring hover:shadow-sm">
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-6">
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Start by adding your work experience, education, and skills as blocks.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Arrange blocks by importance and control what's public or private.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Create tailored resumes and portfolios from your single source of truth.</p>
            </div>
          </div>
        </div>
      </section>
