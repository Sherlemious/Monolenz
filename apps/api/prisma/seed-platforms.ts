...
const PLATFORMS = [
  // Professional
  { name: 'linkedin', display_name: 'LinkedIn', category: 'professional', icon: 'linkedin', base_url: 'https://linkedin.com' },
  { name: 'github', display_name: 'GitHub', category: 'professional', icon: 'github', base_url: 'https://github.com' },
  { name: 'stackoverflow', display_name: 'Stack Overflow', category: 'professional', icon: 'stackoverflow', base_url: 'https://stackoverflow.com' },
  ...
  { name: 'dribbble', display_name: 'Dribbble', category: 'portfolio', icon: 'dribbble', base_url: 'https://dribbble.com' },
  ...
  { name: 'instagram', display_name: 'Instagram', category: 'social', icon: 'instagram', base_url: 'https://instagram.com' },
  { name: 'facebook', display_name: 'Facebook', category: 'social', icon: 'facebook', base_url: 'https://facebook.com' },
